      ...
      <main style={{ flexGrow: 1, padding: '3rem 4rem', overflowY: 'auto' }}>
        ...
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            <button style={{ background: 'var(--sage-800)', border: '1px solid var(--sage-700)', padding: '0.8rem', borderRadius: '50%', color: 'white', cursor: 'pointer', position: 'relative' }}>
              <Bell size={20} />
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '600px', margin: '0 auto' }}>
                    {contracts.map((c, i) => (
                      <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--sage-900)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--sage-700)' }}>
                        ...
                        <button onClick={() => alert('La descarga de PDF asegurado estará disponible al finalizar el KYC avanzado.')} style={{ background: 'transparent', border: '1px solid #34d399', color: '#34d399', padding: '0.6rem 1.2rem', borderRadius: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 'bold' }}>
