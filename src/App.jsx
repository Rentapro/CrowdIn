...
function App() {
  ...
  const faqs = [
    { q: "¿Cómo se respaldan jurídicamente mis inversiones en CrowdIn?", a: "En Factoring, mediante la adquisición de facturas con mérito ejecutivo (Ley 19.983) emitidas a grandes corporaciones. En Leaseback, mediante escritura pública de compraventa con pacto de retroventa e hipoteca de primer grado inscrita en el Conservador de Bienes Raíces (CBR). En Inversión Inmobiliaria, mediante respaldo físico en los activos y terrenos del proyecto." },
