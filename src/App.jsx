...
function App() {
  ...
  const faqs = [
    ...
    { q: "Al finalizar el Mes 12, ¿puedo reinvertir mis ganancias?", a: "Al cierre del ciclo, ejecutamos el pago Bullet devolviendo tu capital a tu cuenta. Si deseas reinvertir en un nuevo proyecto, deberás adquirir nuevas acciones fijas (ej. $1M, $5M). Dado que nuestras acciones tienen montos cerrados, deberás ajustar tu capital para calzar con el tramo deseado." },
